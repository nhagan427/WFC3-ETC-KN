...
# Purpose: To create machine learning training data sets from Mattia Bulla's synthetic sources and STScI's WFC3 IR ETC
...
t_obs_list = [6, 8, 10, 12, 14]
distance_list = [40, 100, 140, 200]
uvis_filters = ['F160W', 'F140W', 'F110W']
extinct_val_list = [0, 1, 2, 3, 4]
exp_time_list = [300, 1400, 2500, 3600]
'''
                        ...
                        for extinct_val in extinct_val_list:
                            for exp_time in exp_time_list:
                                ...
                                if file_name[6] == obs_ang:
                                    ...
                                    # Defining output here in order to check if the output already exists in the destination
                                    output = []
